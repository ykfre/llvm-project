...
uint32_t ClangDeclVendor::FindDecls(clang::DeclContext* context, ConstString name,
                                    bool append,
  ...
  uint32_t ret = FindDecls(context, name, /*append*/ false, max_matches, compiler_decls);
